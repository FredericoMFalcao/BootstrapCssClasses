...
Maecenas sed diam eget risus varius blandit sit amet non magna. Donec id elit non mi porta gravida at eget metus. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit."));
	...
	$body->addChild((new GUI_BUTTON("Large Button","",BUTTON_OPT_LINK|BUTTON_SIZE_LARGE)) ->setType(GRAPHICAL_PROP_CONTEXT_PRIMARY)
	->setOnClickPreRenderFn(function (array $arr) { 
		$tgt = &$arr["target"];
		if ($tgt->getAttribute("hello") == "on") {
			$tgt->setInnerValue("Goodbye Large Button")
			->setAttribute("hello","off");
		}
		else  {
			$tgt->setInnerValue("Hello Large Button")
			->setAttribute("hello","on");
		}
	}));
	...
	$domHead = new DOM_Head(["css"=>["/bootstrap.min.css"], "js"=>["jquery-3.4.1.min.js","bootstrap.min.js"]]);
	$domHead->setTitle("End-2-end testing");

	$domHtml = new DOM_Html($domHead, $body);

	$domHtml->getDomBody()->addChild(new GUI_TYPOGRAPHY_H1("This is how many children there are in the Dom Body. ".$body->getChildrenCount()));
